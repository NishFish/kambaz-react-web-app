  ...
  return (
    <div id="wd-kambaz-navigation" style={{ width: 110 }}
      ...
      <a id="wd-neu-link" target="_blank"
        ...
        <img src="/images/NEU.png" width="65px" /></a>
      ...
      <Link to="/Kambaz/Calendar" id="wd-calender-link"
        className="list-group-item text-white
               bg-black text-center border-0">
...
/*
    <div id="wd-kambaz-navigation">
      ...
      <Link to="/Kambaz/Inbox" id="wd-inbox-link">Inbox</Link><br/><br/>
      <h3><Link to="/Labs" id="wd-labs-link">Labs</Link><br/></h3>
    </div>
*/